...
public class LogIn extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	TextView skipintro = (TextView)findViewById(R.id.skipintro);
      ...
      acerca.setOnClickListener(new OnClickListener() {
		...
		nombre = (EditText) findViewById(R.id.editText1);
		 ...
		 spinner1 = (Spinner) findViewById(R.id.spinner1);
	        ...
	        list.add("Andorra");
	        list.add("Angola");
	        list.add("Antigua y Barbuda");
	        list.add("Arabia Saudí");
	        list.add("Argelia");
	        list.add("Argentina");
	        list.add("Armenia");
	        list.add("Aruba");
	        ...
	        list.add("Belice");
	        list.add("Bermudas");
	        list.add("Bielorrusia");
	        list.add("Bolivia");
	        list.add("Bosnia y Hercegovina");
	        list.add("Brazil");	
	        list.add("Bulgaria");
	        list.add("Camboya");
	        list.add("Camerún");
	        ...
	        list.add("Colombia");
	        list.add("Congo");
	        list.add("Corea del Norte");
	        list.add("Corea del Sur");
	        list.add("Costa de Marfíl");
	        list.add("Costa Rica");
	        list.add("Croacia");
	        list.add("Cuba");
	        list.add("Dinamarca");
	        ...
	        list.add("Irlanda");
	        list.add("Islandia");
	        list.add("Islas Caimán");
	        list.add("Islas Malvinas");
	        list.add("Islas Marianas del Norte");
	        list.add("Islas Salomón");
	        list.add("Islas Vírgenes Americanas");
	        list.add("Islas Vírgenes Británicas");
	        list.add("Israel");
	        list.add("Italia");
	        list.add("Jamaica");
	        list.add("Japón");
	        ...
	        list.add("República Dominicana");
	        list.add("Ruanda");
	        list.add("Rumania");
	        list.add("Rusia");
	        list.add("Samoa");
	        list.add("San Vicente y las Granadinas");
	        list.add("Santa Lucía");
	        list.add("Senegal");
	        list.add("Serbia");
	        list.add("Sierra Leona");
	        list.add("Singapur");
	        list.add("Siria");
	        list.add("Somalia");
	        list.add("Sri Lanka");
	        ...
	        list.add("Tanzania");
	        list.add("Togo");
	        list.add("Trinidad y Tobago");
	        list.add("Túnez");
	        list.add("Turquia");
	        list.add("Ucrania");
	        list.add("Uganda");
	        list.add("Unión Europea");
	        list.add("Uruguay");
	        list.add("Uzbekistán");
	        list.add("Venezuela");
	        list.add("Vietnam");
