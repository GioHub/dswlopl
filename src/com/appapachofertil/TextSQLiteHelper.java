...
public class TextSQLiteHelper extends SQLiteOpenHelper {
	 
    //Sentencia SQL para crear la tabla de Usuarios
    String sqlCreate = "CREATE TABLE Texto (diario TEXT)";
 
    public TextSQLiteHelper(Context contexto, String diario,
                               CursorFactory factory, int version) {
        super(contexto, diario, factory, version);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int versionAnterior, 
        ...
        db.execSQL("DROP TABLE IF EXISTS Texto");
